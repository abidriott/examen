...
import com.abi.agendaws.ListActivity
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK && data != null) {
            ...
            if (contact != null) {
                ...
                id = contact._ID
                txtNombre.setText(contact.nombre)
                txtTelefono1.setText(contact.telefono1)
                txtTelefono2.setText(contact.telefono2)
                txtDireccion.setText(contact.direccion)
                txtNotas.setText(contact.notas)
                cbkFavorite.isChecked = contact.favorite == 1
            }
        } else {
            limpiar()
        }
